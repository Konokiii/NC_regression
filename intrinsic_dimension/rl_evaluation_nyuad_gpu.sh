...
for k in {0..9}
do
  setting1=$((20 * SLURM_ARRAY_TASK_ID + 2 * k))
  setting2=$((20 * SLURM_ARRAY_TASK_ID + 2 * k + 1))
  ...
  python nrc_manifold/rl_evaluation.py --setting $setting1 \
  ...
  export PYTHONPATH=\$PYTHONPATH:/NC_regression
  export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/home/zd662/.mujoco/mujoco210/bin:/usr/lib/nvidia
  python nrc_manifold/rl_evaluation.py --setting $setting2 \
