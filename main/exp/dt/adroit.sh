...
#SBATCH --array=0-39 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
source $SCRATCH/ot4rl/venv/bin/activate
...
python main/exp/dt/adroit.py --setting ${SLURM_ARRAY_TASK_ID}
...
#python main/exp/iclr2025/hopper.py --setting ${SLURM_ARRAY_TASK_ID}
#"