...
#SBATCH --array=0-89 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python main/exp/iclr2025/case2.py --setting ${SLURM_ARRAY_TASK_ID}
"